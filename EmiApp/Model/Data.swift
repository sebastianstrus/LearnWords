...
//    }
    ...
    class func getHardAdjectivesAdvanced() -> [Question] {
        return [
            ...
            Question(polish: "konkurencyjny, konkurencyjny bardzo", english: "competitive, cut-throat", examples: []),
            Question(polish: "zmieszany, zakłopotany", english: "confused, perplexed", examples: []),
            Question(polish: "zatłoczony, tętniący życiem", english: "crowded, bustling", examples: []),
            Question(polish: "zniszczony, poobijany", english: "damaged, battered", examples: []),
            Question(polish: "niebezpieczny, ryzykowny", english: "dangerous, perilous", examples: []),
            Question(polish: "drogi, ceniony", english: "dear, cherished", examples: []),
            Question(polish: "głęboki, gruntowny", english: "deep, profound", examples: []),
            Question(polish: "szczegółowy, skrupulatny", english: "detailed, meticulous", examples: []),
            Question(polish: "brudny, paskudny", english: "dirty, filthy", examples: []),
            Question(polish: "łatwy, bezwysiłkowy", english: "easy, effortless", examples: []),
            Question(polish: "pusty, opuszczony", english: "empty, desolate", examples: []),
            Question(polish: "podekscytowany, wstrząśnięty", english: "excited, thrilled", examples: []),
            Question(polish: "ekscytujący, rozweselający", english: "exciting, exhilarating", examples: []),
            Question(polish: "drogi, cenny", english: "expensive, pricey", examples: []),
            Question(polish: "fantazyjny, wystawny", english: "fancy, lavish", examples: []),
            Question(polish: "gruby, otyły", english: "fat, obese", examples: []),
            Question(polish: "przyjazny, sympatyczny", english: "friendly, amiable", examples: []),
            Question(polish: "zabawny, przezabawny", english: "funny, hilarious", examples: []),
            Question(polish: "zadowolony, uszczęśliwiony", english: "glad, overjoyed", examples: []),
            Question(polish: "świetny, wspaniały", english: "great, terrific", examples: []),
            Question(polish: "szczęśliwy, uradowany", english: "happy, jubilant", examples: []),
            Question(polish: "gorący, upalny, skwarny", english: "hot, scorching, sweltering", examples: []),
            Question(polish: "olbrzymi, rozległy", english: "huge, vast", examples: []),
            Question(polish: "głodny, wygłodzony", english: "hungry, starving", examples: []),
            Question(polish: "ważny, istotny, decydujący", english: "important, vital, crucial", examples: []),
            Question(polish: "ciekawy, urzekający", english: "interesting, captivating", examples: []),
            Question(polish: "leniwy, bezczynny", english: "lazy, idle", examples: []),
            Question(polish: "mały, malutki, nieznaczny", english: "little, tiny, slight", examples: []),
            Question(polish: "głośny, grzmiący", english: "loud, thunderous", examples: []),
            Question(polish: "podły, nikczemny", english: "mean, wicked", examples: []),
            Question(polish: "niechlujny, bardzo niechlujny", english: "messy, slovenly", examples: []),
            Question(polish: "niezbędny, kluczowy, konieczny", english: "necessary, essential, imperative", examples: []),
            Question(polish: "hałaśliwy, wrzaskliwy", english: "noisy, clamorous", examples: []),
            Question(polish: "stary, przestarzały", english: "old, obsolete", examples: []),
            Question(polish: "bolesny, rozdzierający", english: "painful, excruciating", examples: []),
            Question(polish: "idealny, bez skazy", english: "perfect, flawless", examples: []),
            Question(polish: "biedny, w nędzy", english: "poor, destitute", examples: []),
            Question(polish: "szybki, pochopny", english: "quick, hasty", examples: []),
            Question(polish: "cichy, odosobniony", english: "quiet, secluded", examples: []),
            Question(polish: "bogaty, zamożny (sosiety), majętny", english: "rich, well-off, affluent", examples: []),
            Question(polish: "smutny, bolesny, przygnębiony", english: "sad, sorrowful, blue", examples: []),
            Question(polish: "przerażony, bardzo przerażony,  przestraszony", english: "scared, petrified, terrified", examples: []),
            Question(polish: "sensowny, rozważny", english: "sensible, prudent", examples: []),
            Question(polish: "poważny, grobowy", english: "serious, grave", examples: []),
            Question(polish: "nieśmiały, bojaźliwy", english: "shy, timid", examples: []),
            Question(polish: "szczupły, smukły, chudy", english: "slim, slender, lean", examples: []),
            Question(polish: "powolny, niemrawy", english: "slow, sluggish", examples: []),
            Question(polish: "silny, krzepki", english: "strong, robust", examples: []),
            Question(polish: "głupi, niemy, kretyński", english: "stupid, dumb, moronic", examples: []),
            Question(polish: "pyszny, przepyszne", english: "tasty, mouth-watering", examples: []),
            Question(polish: "zmęczony, zmarnowany, przemęczony", english: "tired, wasted, fatigued", examples: []),
            Question(polish: "brzydki, ohydny", english: "ugly, hideous", examples: []),
            Question(polish: "nieprzyjemny, obrzydliwy, nieznośny", english: "unpleasant, gross, obnoxious", examples: []),
            Question(polish: "nieszczęśliwy, nędzny", english: "unhappy, miserable", examples: []),
            Question(polish: "słaby, wątły, kruchy", english: "weak, frail, fragile", examples: []),
            Question(polish: "mokry, przemoczony", english: "wet, soaked", examples: []),
            Question(polish: "chętny, żądny", english: "willing, eager", examples: []),
            Question(polish: "zmartwiony, strapiony", english: "worried, distressed", examples: []),
        ]
    }
