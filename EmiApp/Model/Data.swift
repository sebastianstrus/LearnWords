...
//    }
    ...
    class func getHardAdjectivesAdvanced() -> [Question] {
        return [
            ...
            Question(polish: "bogaty, zamożny (sosiety), majętny", english: "rich, well-off, affluent", examples: ["The area is very rich in minerals.", "The tax cuts were targeted at the less well-off.", "Cigarette smoking used to be commoner among affluent people.", "His parents were very affluent."]),
