...
class Data {
    ...
    class func getLongestQuestions() -> [LongestQuestion] {
        return [
            ...
            LongestQuestion(polish: "zamiatać", english1: "sweep", english2: "swept", english3: "swept", example: "xxx"),
            LongestQuestion(polish: "puchnąć", english1: "swell", english2: "swelled", english3: "swelled/swollen", example: "xxx"),
            LongestQuestion(polish: "pływać", english1: "swim", english2: "swam", english3: "swum", example: "He swept the dirt off the driveway. He swept the crumbs from the table. Her dress swept the ground as she walked. The Blue Jays have a chance to sweep the series."),
