...
class Data {
    ...
    class func getHardAdjectivesAdvanced() -> [Question] {
        return [
            ...
            Question(polish: "denerwujący, nieznośny", english: "annoying, exasperating", examples: []),
            Question(polish: "zły, parszywy", english: "bad, lousy", examples: []),
            Question(polish: "piękny, wspaniały", english: "beautiful, gorgeous", examples: []),
            Question(polish: "duży, ogromny, olbrzymi", english: "big, immense, tremendous", examples: []),
            Question(polish: "nudny, marudny, doczesny", english: "boring, tedious, mundane", examples: []),
            Question(polish: "zajety, zalany (np. pracą)", english: "busy, swamped", examples: []),
            Question(polish: "spokojny, pogodny", english: "calm, serene", examples: []),
            Question(polish: "ostrożny, przezorny", english: "careful, cautious", examples: []),
            Question(polish: "czysty, nieskazitelny", english: "clean, spotless", examples: []),
            Question(polish: "jasny, oczywisty, przejrzysty, ", english: "clear, obvious, lucid", examples: []),
