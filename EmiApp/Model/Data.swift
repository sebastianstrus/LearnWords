...
class Data {
    ...
    class func getHardVerbs() -> [LongQuestion] {
        return [
            ...
            LongQuestion(polish: "uczyć", english1: "teach", preterite: "taught", english3: "taught"),
            LongQuestion(polish: "powiedzieć", english1: "tell", preterite: "told", english3: "told"),
            LongQuestion(polish: "myśleć, sądzić, uważać", english1: "think", preterite: "thought", english3: "thought"),
            LongQuestion(polish: "rzucać", english1: "throw", preterite: "threw", english3: "thrown"),
            LongQuestion(polish: "budzić", english1: "wake", preterite: "woke", english3: "woken"),
            LongQuestion(polish: "nosić, zakładać", english1: "wear", preterite: "wore", english3: "worn"),
            LongQuestion(polish: "rozumieć", english1: "understand", preterite: "understood", english3: "understood"),
            LongQuestion(polish: "wygrywać", english1: "win", preterite: "won", english3: "won"),
            LongQuestion(polish: "pisać", english1: "write", preterite: "wrote", english3: "written"),
            LongQuestion(polish: "obudzić", english1: "awake", preterite: "awoke", english3: "awoken"),
            LongQuestion(polish: "bić", english1: "beat", preterite: "beat", english3: "beaten"),
            LongQuestion(polish: "ugryźć", english1: "bite", preterite: "bit", english3: "bitten"),
            LongQuestion(polish: "krwawić", english1: "bleed", preterite: "bled", english3: "bled"),
            LongQuestion(polish: "wiać, dmuchać", english1: "blow", preterite: "blew", english3: "blown"),
            LongQuestion(polish: "palić, parzyć, płonąć", english1: "burn", preterite: "burned/burnt", english3: "burned/burnt"),
            LongQuestion(polish: "kopać (np. w ziemi)", english1: "dig", preterite: "dug", english3: "dug"),
            LongQuestion(polish: "karmić, żywić", english1: "feed", preterite: "fed", english3: "fed"),
            LongQuestion(polish: "walczyć, bić się", english1: "fight", preterite: "fought", english3: "fought"),
            LongQuestion(polish: "zapominać", english1: "forget", preterite: "forgot", english3: "forgotten"),
            LongQuestion(polish: "wybaczać", english1: "forgive", preterite: "forgave", english3: "forgiven"),
            LongQuestion(polish: "zamarzać", english1: "freeze", preterite: "froze", english3: "frozen"),
            LongQuestion(polish: "zawieszać (coś, np. obraz)", english1: "hang", preterite: "hanged/hung", english3: "hanged/hung"),
            LongQuestion(polish: "chować, ukrywać", english1: "hide", preterite: "hid", english3: "hidden"),
            LongQuestion(polish: "pozwalać", english1: "let", preterite: "let", english3: "let"),
            LongQuestion(polish: "leżeć, kłaść się", english1: "lie", preterite: "lay", english3: "lain"),
            LongQuestion(polish: "zapalać, rozpalać, oświetlać", english1: "light", preterite: "lighted/lit", english3: "lighted/lit"),
            LongQuestion(polish: "rzucać, opuszczać", english1: "quit", preterite: "quit", english3: "quit"),
            LongQuestion(polish: "podnosić się, wzrastać, wschodzić (o słońcu)", english1: "rise", preterite: "rose", english3: "risen"),
            LongQuestion(polish: "trząść, potrząsać", english1: "shake", preterite: "shook", english3: "shaken"),
            LongQuestion(polish: "świecić, błyszczeć", english1: "shine", preterite: "shone", english3: "shone"),
